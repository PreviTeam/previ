...
echo '<div class="container-fluid">',
			'<div class="inputs">',
				...
				'<div class="input-group mb-3">',
				  ...
				  '</div>',
				  '<input type="text" data-input="version" class="form-control"',$vers,' aria-label="Default">',
				'</div>',
				...
				'<div class="input-group mb-3">',
				  ...
				  '</div>',
				  '<input type="text" data-input="designation" class="form-control"',$de,' aria-label="Default">',
				'</div>',
