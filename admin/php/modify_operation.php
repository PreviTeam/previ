...
echo '<div class="container-fluid">',
			'<div class="inputs">',
				...
				'<div class="input-group mb-3">',
				  ...
				  '</div>',
				  '<textarea data-input="contenu" class="form-control form_',$caller,'" title="Texte a afficher pour l\'agent sur l\'application"> ', entities_protect($content) ,'</textarea>',
				'</div>',

				'<select data-input="select" class="custom-select form_',$caller,'" title="Type de la demande : question fait oui/non ou texte à saisir">',
